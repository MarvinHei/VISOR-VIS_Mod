...
if __name__ == '__main__':
    ...
    json_files_path = 'epick_visor/Interpolations-DenseAnnotations/train'
    output_directory = 'out'
    sparse_rgb_images_root = 'epick_visor/GroundTruth-SparseAnnotations/rgb_frames/train/P01'
    videos_path = '../EPIC-KITCHENS/P01/videos' 
